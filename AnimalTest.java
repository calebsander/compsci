...
class AnimalTest {
	public static void main(String[] args) {
		...
		testRabbit.age(5);
		System.out.println("Age is now: " + testRabbit.age(0));
		System.out.println();

		System.out.println("Testing health system");
		System.out.println("Damaging dying rabbit");
		...
		String[] vegetablePossibilities = {"Lettuce", "Onion", "Green Beans", "Corn"};
		fullRabbit.eat(vegetablePossibilities[Math.floor(Math.random() * vegetablePossibilities.length)]);
