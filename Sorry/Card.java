class Card {
	...
	private final static String[] CAPTIONS = {
		...
		"",
		"Move one pawn seven spaces forward or split the seven spaces between two pawns (such as four spaces for one pawn and three for another). The seven cannot be split into a six and one or a five and two for the purposes of moving out of Start. The entire seven spaces must be used one way or the other or the turn is lost.",
